...
namespace NitroxPatcher.Patches.Dynamic
{
    ...
    {
        private static readonly MethodInfo TARGET_METHOD = Reflect.Method((Base t) => t.SpawnPiece(default(Base.Piece), default(Int3), default(Vector3), default(Quaternion), default(Base.Direction?), default(BaseDeconstructable)));
